...
exports.renderInformesPage = renderInformesPage;
...
function renderInformesPage(injectStyles, navigate) {
    ...
    ${(0, title_bar_1.renderTitleBar)('Consolidar Informes')}
...
function showResults(results) {
    ...
    let downloadHTML = `
        ...
        <p class="success-message" style="text-align: center; margin: 15px auto; max-width: 600px;">
            ${(0, icons_1.getIcon)('check-circle', 20)} <strong>Consolidación Completada:</strong> Los archivos de informes han sido consolidados exitosamente. 
        ...
        downloadHTML += `
            <div style="display: flex; justify-content: center; margin: 30px 0;">
                <a href="${processedData.consolidatedFile.url}" 
                   ...
                   class="download-btn">
                    <span class="download-icon">${(0, icons_1.getIcon)('download', 24)}</span>
    ...
    selectedFiles.forEach(file => {
        ...
        processedItem.innerHTML = `
            <div class="processed-file-info">
                <div class="processed-file-name">${(0, icons_1.getIcon)('file-spreadsheet', 16)} ${file.name}</div>
            ...
            <div class="processed-file-status ${isSuccess ? 'status-success' : 'status-error'}">
                ${isSuccess ? (0, icons_1.getIcon)('check', 16) + ' Procesado' : (0, icons_1.getIcon)('x', 16) + ' Error'}
            </div>
        `;
