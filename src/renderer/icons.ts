// icons.ts - Sistema de iconos usando Lucide
// Los iconos usan stroke="currentColor" para heredar el color del texto
...
export const icons: Record<string, string> = {
    ...
    'download': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V3"/><path d="m7 10 5 5 5-5"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>`,
    ...
    'chart-bar': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="20" y2="10"/><line x1="18" x2="18" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/></svg>`,
    ...
    'toggle-left': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="12" x="2" y="6" rx="6" ry="6"/><circle cx="8" cy="12" r="2"/></svg>`,
    ...
    'maximize2': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>`,

    'minimize2': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="8" x2="16" y1="12" y2="12"/></svg>`,
};

/**
 * Obtiene el SVG de un icono por su nombre
 * @param name - Nombre del icono
 * @param size - Tamaño opcional (por defecto hereda del SVG: 24)
 * @returns String HTML del SVG o string vacío si no existe
 */
 ...
 * @returns String HTML del span con el SVG dentro
 */
export function iconSpan(name: string, className: string = '', size?: number): string {
    const svg = getIcon(name, size);
    return `<span class="icon ${className}">${svg}</span>`;
}

// Exponer globalmente para uso en HTML onclick, etc.
(window as any).getIcon = getIcon;
(window as any).iconSpan = iconSpan;
